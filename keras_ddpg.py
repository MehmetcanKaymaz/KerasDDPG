...
import numpy as np
from environment_gym import Env_Gym
...
actor_model.load_weights("actor_initial.h5")
...
actor_model.save_weights("actor_trained.h5")
critic_model.save_weights("critic_trained.h5")
